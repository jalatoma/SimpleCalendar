...
"""
"""
from project1_solution import validate_input, next_date, previous_date
from project1_dotw_solution import get_doomsday_dotw, get_dotw
from project1_events_solution import read_events, get_events_binary_search, sort_events, sort_even
"""
...
assert validate_input("2-29-2024") == (2, 29, 2024)
assert validate_input("2-29-2021") == None
...
assert get_doomsday_dotw(1875) == 0
...
assert get_events_binary_search((11, 2, 2021)) == ["Dia de los Muertos", "All Soul's Day"] or get_events_binary_search(
    (11, 2, 2021)) == ["All Soul's Day", "Dia de los Muertos"]
